...
const REGISTRY_ADDRESS = process.env.NEXT_PUBLIC_PULSE_REGISTRY_ADDRESS
  || (process.env.NEXT_PUBLIC_CHAIN_ID === '8453'
    ? process.env.NEXT_PUBLIC_PULSE_REGISTRY_MAINNET || '0xe61C615743A02983A46aFF66Db035297e8a43846'
...
const TOKEN_ADDRESS = process.env.NEXT_PUBLIC_PULSE_TOKEN_ADDRESS
  || (process.env.NEXT_PUBLIC_CHAIN_ID === '8453'
    ? process.env.NEXT_PUBLIC_PULSE_TOKEN_MAINNET || '0x21111B39A502335aC7e45c4574Dd083A69258b07'
    : process.env.NEXT_PUBLIC_PULSE_TOKEN_SEPOLIA || '0x21111B39A502335aC7e45c4574Dd083A69258b07');
